...
public class CoreDataHandler: NSObject {
   ...
   @objc public func getAllDatasGroupBy(entity:String,property:AnyObject)-> NSArray {
        let fetchRequest : NSFetchRequest = NSFetchRequest<NSFetchRequestResult> (entityName: entity)
...
public func getMaxOfDatas(entity:String,property:String,predicate:NSPredicate?)-> Double? {
   ...
   @objc  public func deleteAllDataWithCondition(name: String,predicate:NSPredicate?) {
        do {
   ...
   @objc public func deleteAllData(name: String) {
        do {
            let fetchRequest = NSFetchRequest<NSFetchRequestResult>(entityName: name)
            if #available(iOS 9.0, *) {
                let deleteRequest = NSBatchDeleteRequest(fetchRequest: fetchRequest)
   ...
   @objc public func updateValue(entityName:String,objectKey:String,newObject:AnyObject){
